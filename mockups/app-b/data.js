window.FOODIO = {
  restaurants: [
    ...
    },
    {
      ...
      openingHours: [
        { dayOfWeek: 2, opensAt: '12:00', closesAt: '22:00' },
        { dayOfWeek: 3, opensAt: '12:00', closesAt: '22:00' },
        { dayOfWeek: 4, opensAt: '12:00', closesAt: '22:00' },
        { dayOfWeek: 5, opensAt: '12:00', closesAt: '23:00' },
        { dayOfWeek: 6, opensAt: '12:00', closesAt: '23:00' },
      ],
      reviews: [
        {
          id: 'rev-3',
    ...
    },
    {
      ...
      openingHours: [
        ...
        { dayOfWeek: 1, opensAt: '11:30', closesAt: '21:30' },
        { dayOfWeek: 2, opensAt: '11:30', closesAt: '21:30' },
        { dayOfWeek: 3, opensAt: '11:30', closesAt: '21:30' },
        { dayOfWeek: 4, opensAt: '11:30', closesAt: '21:30' },
        { dayOfWeek: 5, opensAt: '11:30', closesAt: '21:30' },
    ...
    },
    {
      ...
      openingHours: [
        ...
        { dayOfWeek: 5, opensAt: '11:00', closesAt: '23:00' },
    ...
    },
    {
      ...
      currency: 'USD',
      deliveryFeeMinor: 0,
      deliveryEstimate: { minMinutes: 15, maxMinutes: 20 },
      minMinutes: 15,
      maxMinutes: 20,
      image:
      ...
      openingHours: [
        ...
        { dayOfWeek: 1, opensAt: '07:00', closesAt: '20:00' },
        { dayOfWeek: 2, opensAt: '07:00', closesAt: '20:00' },
        { dayOfWeek: 3, opensAt: '07:00', closesAt: '20:00' },
        { dayOfWeek: 4, opensAt: '07:00', closesAt: '20:00' },
        { dayOfWeek: 5, opensAt: '07:00', closesAt: '20:00' },
      ...
      reviews: [
        {
          ...
          rating: 5,
          comment:
            'My go-to healthy spot. The acai bowl is incredible and delivery is always fast.',
          postedAt: '2026-07-22',
        },
      ],
      latitude: 37.7925,
    ...
    },
    {
      ...
      deliveryEstimate: { minMinutes: 30, maxMinutes: 40 },
      minMinutes: 30,
      maxMinutes: 40,
      image:
      ...
      openingHours: [
        { dayOfWeek: 0, opensAt: '12:00', closesAt: '22:30' },
        { dayOfWeek: 1, opensAt: '12:00', closesAt: '22:30' },
        { dayOfWeek: 2, opensAt: '12:00', closesAt: '22:30' },
        { dayOfWeek: 3, opensAt: '12:00', closesAt: '22:30' },
        { dayOfWeek: 4, opensAt: '12:00', closesAt: '22:30' },
        { dayOfWeek: 5, opensAt: '12:00', closesAt: '22:30' },
        { dayOfWeek: 6, opensAt: '12:00', closesAt: '22:30' },
      ],
      reviews: [
        {
          id: 'rev-8',
    ...
    },
    {
      ...
      openingHours: [
        ...
        { dayOfWeek: 5, opensAt: '10:00', closesAt: '22:00' },
        { dayOfWeek: 6, opensAt: '10:00', closesAt: '22:00' },
      ],
      reviews: [
        {
          id: 'rev-9',
    ...
    },
    {
      ...
      openingHours: [
        { dayOfWeek: 0, opensAt: '09:00', closesAt: '21:00' },
        { dayOfWeek: 1, opensAt: '09:00', closesAt: '21:00' },
        { dayOfWeek: 2, opensAt: '09:00', closesAt: '21:00' },
        { dayOfWeek: 3, opensAt: '09:00', closesAt: '21:00' },
        { dayOfWeek: 4, opensAt: '09:00', closesAt: '21:00' },
        { dayOfWeek: 5, opensAt: '09:00', closesAt: '21:00' },
        { dayOfWeek: 6, opensAt: '09:00', closesAt: '21:00' },
      ],
      reviews: [
        {
          id: 'rev-10',
    ...
    },
    {
      ...
      openingHours: [
        { dayOfWeek: 0, opensAt: '08:00', closesAt: '17:00' },
        { dayOfWeek: 2, opensAt: '07:00', closesAt: '19:00' },
        { dayOfWeek: 3, opensAt: '07:00', closesAt: '19:00' },
        { dayOfWeek: 4, opensAt: '07:00', closesAt: '19:00' },
        { dayOfWeek: 5, opensAt: '07:00', closesAt: '19:00' },
        { dayOfWeek: 6, opensAt: '08:00', closesAt: '17:00' },
      ],
      reviews: [
        {
          id: 'rev-11',
  ...
  orders: [
    {
      ...
      currency: 'USD',
      status: 'delivered',
      placedAt: '2026-07-26T15:10:31.198Z',
      lines: [
        {
          menuItemId: 'r1-pop-1',
          name: 'Birria Tacos',
